      ...
      <div className="mx-auto max-w-screen-xl py-8 text-center lg:py-16">
        ...
        <div className="mt-24 flex gap-10 text-left">
          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="flex gap-5">
              ...
              />
              <div>
                <h1 className="mb-2 text-2xl font-semibold">Fadhilah Rahman</h1>
                <p className="text-lg font-semibold text-slate-500">
                  UI/UX Designer
                </p>
              </div>
            ...
            <div className="flex gap-5">
              ...
              />
              <div>
                <h1 className="mb-2 text-2xl font-semibold">Luqman Herifa</h1>
                <p className="text-lg font-semibold text-slate-500">
                  Software Engineer
                </p>
              </div>
        ...
        <div className="flex gap-10 text-left">
          ...
          <div className="flex flex-1 flex-col">
            ...
            <hr className="my-8 border-gray-200" />
            <div>
              <h1 className="mb-5 text-3xl font-semibold">Atma Karya Teknik</h1>
              <div className="flex gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6"
